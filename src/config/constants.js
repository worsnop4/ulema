...
export const THEMES = {
  ...
  SENJA_DIORAMA: 'senja-diorama',
  ISTANA_KENCANA: 'istana-kencana',
}
...
export const THEME_CATEGORY_MAP = {
  ...
  [THEMES.SENJA_DIORAMA]: THEME_CATEGORIES.MOTION_3D,
  [THEMES.ISTANA_KENCANA]: THEME_CATEGORIES.MOTION_3D,
}

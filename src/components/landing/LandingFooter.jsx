...
import { waLink, ADMIN_WHATSAPP_DISPLAY } from '../../config/constants'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 reveal">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a href={waLink()} target="_blank" rel="noopener noreferrer" className="w-9 h-9 glass rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={waLink()} target="_blank" rel="noopener noreferrer" className="text-white text-sm hover:text-blue-300 transition-colors">{ADMIN_WHATSAPP_DISPLAY}</a>
                </div>
              </li>
              <li className="flex items-start gap-3">

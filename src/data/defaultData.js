...
export const DEFAULT_THEMES = [
  ...
  { id: 21, name: 'Velour Olive', code: 'LUX-007', emoji: '🎭', thumbnail: '/themes/Luxury/theme-4/bg-hero-poster.jpg', layout: 'velour-olive', colors: ['#14150F', '#D9BC7A', '#F4EFE6'], desc: 'Tema Luxury "panggung pelaminan": latar video kain velvet olive yang diam saat konten di-scroll, cover tersibak dua kain velvet, navigasi scroll-snap fullscreen dengan rail titik, ornamen emas & kelopak berjatuhan', category: 'Luxury', themeType: 'video' },
  { id: 22, name: 'Senja Diorama', code: 'MOT-001', emoji: '🌄', thumbnail: '/themes/Motion/theme-1/thumb.jpg', layout: 'senja-diorama', colors: ['#1A1526', '#E8A87C', '#D9A441'], desc: 'Tema Motion berlapis: langit senja, siluet bukit, barisan pohon, dan dedaunan depan bergerak dengan laju berbeda saat digulir sehingga terbentuk kedalaman sungguhan. Seluruh geraknya dari transform CSS, tanpa video sama sekali.', category: 'Motion', themeType: 'photo' },
  { id: 23, name: 'Istana Kencana', code: 'MOT-002', emoji: '🏛️', thumbnail: '/themes/Motion/theme-2/thumb.jpg', layout: 'istana-kencana', colors: ['#F7F1E6', '#A8823A', '#3A2E23'], desc: 'Tema Motion sinematik: tamu tiba di gerbang emas yang beku, dan begitu undangan dibuka kameranya berjalan sendiri menembus gerbang, halaman istana, dan lorong pualam sampai berhenti di tangga ballroom di bawah lampu kristal yang bernapas pelan selamanya. Marmer gading dengan tulisan gelap, satu-satunya tema terang di kategori ini.', category: 'Motion', themeType: 'photo' },
]

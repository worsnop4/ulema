      ...
      <div id="top" className="w-full relative h-full flex flex-col overflow-x-hidden"
        ...
        {opened && (
          <motion.div className="flex flex-col w-full"
            ...
            {/* Hero, Quote, Couple, Acara, RSVP & Ucapan, Footer, nav — added in
                the following build parts (see TodoWrite / conversation). */}
            <div style={{ padding: '80px 28px', textAlign: 'center', color: c.muted, fontFamily: F.sans, fontSize: 13 }}>

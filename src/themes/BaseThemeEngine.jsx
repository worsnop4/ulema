    ...
    >
      ...
      {data.music !== false && (
        <button
          ...
          className={`fixed top-6 right-4 md:absolute md:top-6 md:right-4 z-50 w-12 h-12 rounded-full shadow-md flex items-center justify-center transition-all duration-500 ${
            scrolled ? 'opacity-0 pointer-events-none scale-90 translate-y-[-10px]' : 'opacity-100 scale-100 translate-y-0'
          }`}
          style={{

...
import { Clock, MapPin, Heart, Instagram } from 'lucide-react'
...
fs.writeFileSync('src/themes/MinangElegantTheme.jsx', code);
console.log('Rewrite v2 done. Lines:', code.split('\n').length);
